...
const youtube = new YouTube("AIzaSyAuK47IYgy_H0wrXU-jZFj8YHGr1u0wqBc"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyAuK47IYgy_H0wrXU-jZFj8YHGr1u0wqBc"; ///تعديل اساسي سوي اي بي اي جديد
...
client.user.setActivity(`${prefix}help`, { type: "Developed by ࿋♕༒ƵɆɌØ༒♕࿋
#3746" }
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@758864807285489684>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
